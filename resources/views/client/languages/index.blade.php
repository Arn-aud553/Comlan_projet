...
<head>
    ...
    <title>Langues Nationales - Culture Bénin</title>
    <!-- Fonts -->
    ...
    <style>
        :root {
            --indigo-header: #8b5cf6; /* Indigo/Purple for Languages */
            --bg-color: #f8fafc;
...
<body>
    ...
    <header class="header-section">
        <h1 class="page-title">Langues du Bénin</h1>
        <p style="margin-top: 15px; font-size: 18px; opacity: 0.9;">Découvrez la richesse linguistique de notre patrimoine.</p>
    </header>
    ...
    <div class="container">
        ...
        <div class="languages-grid">
            @forelse($languages as $langue)
            <div class="lang-card">
                <span class="lang-code">{{ $langue->code_langue }}</span>
                <h3 class="lang-name">{{ $langue->nom_langue }}</h3>
                <p class="lang-desc">{{ Str::limit($langue->description, 100) }}</p>
                <div style="margin-top: 20px; font-size: 13px; color: #8b5cf6; font-weight: 600;">
                    <a href="{{ route('client.languages.detail', $langue->id_langue) }}" style="text-decoration: none; color: inherit;">
            ...
            <div style="grid-column: 1 / -1; text-align: center; padding: 60px;">
                <p style="font-size: 18px; color: #94a3b8;">Aucune langue répertoriée pour le moment.</p>
            </div>
            @endforelse
        </div>
    </div>
