            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-primary text-white py-3">
                    <h4 class="mb-0">
                        ...
                        Paiement pour : {{ $media->titre ?? $media->nom_fichier }}
                    </h4>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>Média :</strong> {{ $media->titre ?? $media->nom_fichier }}</p>
                                <p><strong>Type :</strong> {{ ucfirst($media->type_fichier) }}</p>
                                <p><strong>Auteur :</strong> {{ $media->utilisateur->name ?? 'Inconnu' }}</p>
                            </div>
                            <div class="col-md-6 text-end">
                                <h3 class="text-primary">{{ $media->prix_formate }}</h3>
                    ...
                    <!-- Payment Form -->
                    <form action="{{ route('client.media.paiement.process', $media->id) }}" method="POST" id="paymentForm">
                        @csrf
