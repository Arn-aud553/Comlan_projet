...
<head>
    ...
    <title>{{ $region->nom_region }} - Détails - Culture Bénin</title>
    <!-- Fonts -->
    ...
    <style>
        :root {
            --header-bg: #1e293b; /* Midnight Blue for consistency */
            --teal-accent: #14b8a6;
            --bg-color: #f8fafc;
            --text-color: #334155;
        }
...
<body>
    ...
    <header class="header-section">
        <h1 class="page-title">{{ $region->nom_region }}</h1>
        <p style="margin-top: 15px; opacity: 0.9; font-size: 18px;">Informations Régionales</p>
    </header>

    <div class="container">
        <a href="{{ route('client.regions.index') }}" class="back-btn">
