                ...
                <div class="card-header card-header-gradient-commentaires py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-0 fs-4">Créer un Nouveau Commentaire</h5>
                                <p class="mb-0 opacity-75" style="font-size: 0.9rem;">
                                    Ajouter un commentaire au système
                                </p>
                            </div>
                        </div>
                        <div>
                            <a href="{{ route('commentaires.index') }}" class="btn btn-outline-light btn-sm">
                            ...
                            <div class="row">
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea name="texte" 
                                              ...
                                              autofocus>{{ old('texte') }}</textarea>
                                    @error('texte')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Maximum 2000 caractères</div>
                                    <div class="mt-2 small text-muted" id="charCount">0/2000 caractères</div>
                                </div>
                                    ...
                                    <select name="id_utilisateur" 
                                        ...
                                        @foreach($utilisateurs ?? [] as $utilisateur)
                                            <option value="{{ $utilisateur->id }}" 
                                                    {{ old('id_utilisateur') == $utilisateur->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <button type="reset" class="btn btn-commentaire-secondary">
...
$(document).ready(function() {
    ...
    $('#texte').on('input', function() {
        ...
        $('#charCount').text(length + '/2000 caractères');
    ...
    if ($('#id_utilisateur option').length <= 1) {
        $.get('/api/utilisateurs', function(data) {
            ...
            $('#id_utilisateur').val('{{ old("id_utilisateur") }}');
        });
    }
});
</script>
