                ...
                <div class="card-header card-header-gradient-contenus py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-0 fs-4">Créer un Nouveau Contenu</h5>
                                <p class="mb-0 opacity-75" style="font-size: 0.9rem;">
                                    Ajouter un contenu au catalogue
                                </p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea name="texte" 
                                              ...
                                              rows="10"
                                              required
                                              placeholder="Contenu textuel détaillé...">{{ old('texte') }}</textarea>
                                    @error('texte')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    @error('date_creation')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Date de création (par défaut: maintenant)</div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    @error('id_moderateur')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Optionnel - sera automatiquement assigné lors de la validation</div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <button type="reset" class="btn btn-contenu-secondary">
...
// Remplir automatiquement la date de création avec l'heure actuelle si vide
document.addEventListener('DOMContentLoaded', function() {
    const dateCreationField = document.getElementById('date_creation');
    if (!dateCreationField.value) {
        const now = new Date();
        ...
        dateCreationField.value = `${year}-${month}-${day}T${hours}:${minutes}`;
    }
});

// Si le statut est publié, suggérer la date actuelle pour la validation
