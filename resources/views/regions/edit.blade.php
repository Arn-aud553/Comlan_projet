                ...
                <div class="card-header card-header-gradient-regions py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-0 fs-4">Modifier la Région</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea name="description" 
                                              ...
                                              rows="6"
                                              placeholder="Description géographique, informations historiques, caractéristiques culturelles...">{{ old('description', $region->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
